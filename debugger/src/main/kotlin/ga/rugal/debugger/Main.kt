...
import ga.rugal.debugger.ui.MainWindow
...
fun main(args: Array<String>) {
  ...
  TerminalScreen(terminal).use { screen ->
    screen.startScreen()
    val textGUI: WindowBasedTextGUI = MultiWindowTextGUI(SeparateTextGUIThread.Factory(), screen)

    textGUI.addWindow(MainWindow)

    (textGUI.guiThread as AsynchronousTextGUIThread).also {
      it.start()
      it.waitForStop()
    }
  }
